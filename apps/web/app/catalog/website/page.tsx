...
export default function WebsiteCatalog() {
  ...
  const [filters, setFilters] = useState<SearchFilters>({
    q: '',
    vendors: [],
    categories: ['Website'], // Фиксированная категория - только веб-сайты
    subcategories: [],
    sortBy: 'relevance',
    sortOrder: 'DESC',
  });
  ...
  const clearFilters = () => {
    setFilters({
      q: '',
      vendors: [],
      categories: ['Website'], // Всегда только веб-сайты
      subcategories: [],
      sortBy: 'relevance',
      sortOrder: 'DESC',
    });
      ...
      <div className="container mx-auto px-4 py-8 pt-24">
        ...
        <div className="mb-8">
          <div className="glass p-6 rounded-3xl">
            <h1 className="text-3xl font-bold text-ink mb-2">Website Catalog</h1>
            <p className="text-ink/70">Find the perfect website design for your project</p>
          </div>
        </div>
            ...
            <div className="flex items-center gap-2">
              {loading ? (
                ...
                <span className="text-ink/70 text-sm">
                  Found: {searchData?.total || 0} website demos
                </span>
              )}
            </div>
        ...
        {demo.regularPrice > 0 && (
          ...
          <div className="text-center py-12">
            <div className="text-ink/70 mb-4">No website demos found</div>
            <button
              onClick={clearFilters}
